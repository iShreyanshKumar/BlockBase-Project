...
function App() {
  ...
  const contractAddress = "0x4EB991a54D2096C70E04B586D90cBb8608b0CbA5"; // Paste the address recieved from Remix IDE here
            ...
            : (
              <div>
                ...
                <button
                  ...
                  onClick={handleGetMyName}
                >
                  {isFetchingName ? "Fetching..." : "Get My Name"}
                </button>
                {myFetchedName && (
                  <div
                    style={{
                  ...
                  >
                    Your registered name: {myFetchedName}
                  </div>
                )}
